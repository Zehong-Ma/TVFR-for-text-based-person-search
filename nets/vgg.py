...
def vgg_16(inputs,
  ...
  with variable_scope.variable_scope(scope, 'vgg_16', [inputs]) as sc:
    ...
    with arg_scope(
      ...
      net = layers_lib.max_pool2d(net, [2, 2], scope='pool5')
      # Use conv2d instead of fully_connected layers. use same padding instead of valid 
      # net = layers.conv2d(net, 4096, [7, 7], padding='SAME', scope='fc6')
      end_points = utils.convert_collection_to_dict(end_points_collection)
      end_points['FeatureMap'] = net
      # Use global pooling instead of conv2d 7*7
