...
tf.app.flags.DEFINE_integer('group_size', 6,
                            'The number of fc_layers.')

tf.app.flags.DEFINE_integer('image_height', 384,
                            "image size of height which should be 32*x.")

tf.app.flags.DEFINE_integer('image_width', 128,
                            "image size of width which should be 32*x.")

tf.app.flags.DEFINE_integer('num_epochs', 160,
...
tf.app.flags.DEFINE_string('random_filter', 'no', 
                           'if the filter is random generated. 3 choices: no, uniform, norm ')
...
tf.app.flags.DEFINE_boolean('IMAGE_PART_LOSS', False,
                            "whether IMAGE_PART_LOSS.")

tf.app.flags.DEFINE_boolean('IMAGE_PART_LOSS_before_multiply_text_weight', True,
                            "whether part features multiply text weight before sent to image part loss.")

tf.app.flags.DEFINE_boolean('IMAGE_ID_LOSS', False,
                            "whether IMAGE_ID_LOSS.")

tf.app.flags.DEFINE_boolean('TEXT_ID_LOSS', False,
                            "whether TEXT_ID_LOSS.")

tf.app.flags.DEFINE_float('IMAGE_PART_LOSS_weight', 1.0,
                          'IMAGE PART Loss weight.')
...
tf.app.flags.DEFINE_float('end_learning_rate', 0.0000030,
...
tf.app.flags.DEFINE_float('num_epochs_per_decay', 40.0,
